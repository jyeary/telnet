 ...
 */
package com.bluelotussoftware.telnet;
 ...
 * terminal type will be sub-negotiated.</p>
 * <p>
...
public class Telnet implements Runnable, TelnetNotificationHandler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length < 1) {
            System.err.println("Usage: Telnet <remote-ip> [<remote-port>]");
            System.exit(1);
        }
        ...
        try {
            ...
            System.err.println(MessageFormat.format("Exception while opening the spy file: {0}", e.getMessage()));
        }
        ...
        while (true) {
            ...
            try {
                ...
                System.out.println(MessageFormat.format("Telnet Client {0}", VERSION));
                    ...
                    try {
                        ...
                        if (ret_read > 0) {
                            ...
                            if (line.startsWith("AYT")) {
                                ...
                                } catch (IOException | NumberFormatException | InvalidTelnetOptionException e) {
                                ...
                                try {
                                    ...
                                    //OutputStream closed (client closed connection).
                        ...
                        System.err.println(MessageFormat.format("Exception while reading keyboard:{0}", e.getMessage()));
                        end_loop = true;
                    }
                ...
                try {
                    ...
                    System.err.println(MessageFormat.format("Exception while connecting:{0}", e.getMessage()));
                }
            } catch (IOException e) {
                System.err.println(MessageFormat.format("Exception while connecting:{0}", e.getMessage()));
                System.exit(1);
    ...
    public void run() {
        ...
        try {
            ...
            System.err.println(MessageFormat.format("Exception while reading socket:{0}", e.getMessage()));
        }

        try {
            tc.disconnect();
        } catch (IOException e) {
            System.err.println(MessageFormat.format("Exception while closing telnet:{0}", e.getMessage()));
        }
    }
}
